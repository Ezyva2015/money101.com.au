...
function options_typography_get_google_fonts() {
	// Google Fonts list version 1.2 118 fonts
	$google_faces = array(
...
if ( !function_exists( 'options_typography_google_fonts' ) ) {
	function options_typography_google_fonts() {
		...
		$headings = of_get_option('headings', false);
		$navigation_font = of_get_option('navigation_font', false);
		$body_font = of_get_option('body_font', false);
		$hero_text_font = of_get_option('hero_text_font', false);
		$hero_title_font = of_get_option('hero_title_font', false);
